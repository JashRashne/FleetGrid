        ...
        try:
            ...
            for log_data in daily_logs:
                DailyLog.objects.create(
                    ...
                    truck_id=log_data.get("truck_id", "TRK-9042"),
                    total_driving_hours=log_data.get("totals", {}).get("DRIVING", 0.0),
                    total_on_duty_hours=log_data.get("totals", {}).get("ON_DUTY_NOT_DRIVING", 0.0),
                    total_off_duty_hours=log_data.get("totals", {}).get("OFF_DUTY", 0.0),
                    total_sleeper_hours=log_data.get("totals", {}).get("SLEEPER_BERTH", 0.0),
                    is_fmcsa_compliant=log_data.get("totals", {}).get("is_compliant", True),
                    grid_intervals_json=log_data.get("duty_intervals", []),
